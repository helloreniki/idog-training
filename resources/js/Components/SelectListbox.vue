<template>
<div class="w-full">
  <Listbox :model-value="props.modelValue" @update:modelValue="(option) => emit('update:modelValue', option)">
    <div class="relative mt-1">
      ...
      >
        <span class="block truncate">{{ props.modelValue ?? "Choose category..." }}</span>
        <span
      ...
      >
        ...
        >
          <ListboxOption
            ...
            v-for="category, index in props.options"
            :key="index"
            :value="category"
            as="template"
          >
